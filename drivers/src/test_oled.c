...
void testfillrect(int fd) {
  ...
  for (i = 0; i < SSD1306_LCDHEIGHT / 2; i += 3) {
    // alternate colors
    fillRect(i, i, SSD1306_LCDWIDTH - i * 2, SSD1306_LCDHEIGHT - i * 2,
             color % 2);
    Display(fd);
    usleep(1000);
    color++;
...
void testdrawroundrectint(int fd) {
  ...
  for (i = 0; i < SSD1306_LCDHEIGHT / 2 - 2; i += 2) {
    drawRoundRect(i, i, SSD1306_LCDWIDTH - 2 * i, SSD1306_LCDHEIGHT - 2 * i,
                  SSD1306_LCDHEIGHT / 4, WHITE);
    Display(fd);
    usleep(1000);
  }
}
...
void testfillroundrect(int fd) {
  ...
  for (i = 0; i < SSD1306_LCDHEIGHT / 2 - 2; i += 2) {
    fillRoundRect(i, i, SSD1306_LCDWIDTH - 2 * i, SSD1306_LCDHEIGHT - 2 * i,
                  SSD1306_LCDHEIGHT / 4, color);
    if (color == WHITE)
      color = BLACK;
    else
      color = WHITE;
...
void display_bitmap(int fd) { drawBitmap(30, 16, logo16_glcd_bmp, 16, 16, 1); }
...
void testdrawbitmap(int fd, const unsigned char *bitmap, unsigned char w,
                    unsigned char h) {
